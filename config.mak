...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --disable-static --enable-gpl --enable-libx264 --enable-libmp3lame
prefix=/usr/local
...
EXTRALIBS=-lva -lva-x11 -lva -lxcb -lxcb-shm -lxcb -lX11 -lasound -lSDL -lx264 -lpthread -lmp3lame -lm -lz -pthread -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
